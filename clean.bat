...
cls
del /s /q /f %LocalAppData%\FiveM\FiveM.app\CitizenFX_SubProcess_game_2545.bin
cls
del /s /q /f %LocalAppData%\FiveM\FiveM.app\CitizenFX_SubProcess_game_2612.bin
cls
del /s /q /f %LocalAppData%\FiveM\FiveM.app\CitizenFX_SubProcess_game_2699.bin
cls
del /s /q /f %LocalAppData%\FiveM\FiveM.app\CitizenFX_SubProcess_game_2802.bin
cls
del /s /q /f %LocalAppData%\FiveM\FiveM.app\CitizenFX_SubProcess_game_2944.bin
cls
del /s /q /f %LocalAppData%\FiveM\FiveM.app\CitizenFX_SubProcess_game_3095.bin
cls
del /s /q /f %LocalAppData%\FiveM\FiveM.app\CitizenFX_SubProcess_game_3258.bin
cls
